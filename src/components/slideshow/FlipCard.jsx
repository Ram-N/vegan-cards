...
/**
 * FlipCard component - a reusable card with front and back content and flip animation
 * Extracted from GenericCard for use in slideshow and other card-based apps
 * 
 * @param {Object} props
